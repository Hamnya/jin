...
char pass[] = "52005200ys";   // your network password
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.print("<h1>Click <a href=\"/H\">here</a> turn the LED on pin 9 on<br></h1>");
            client.print("<h1>Click <a href=\"/L\">here</a> turn the LED on pin 9 off<br></h1>");
