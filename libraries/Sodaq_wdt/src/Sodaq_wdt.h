...
enum wdt_period : uint8_t 
{
  ...
  WDT_PERIOD_16X      = WDTO_16S     // 8000ms = 8s
  WDT_PERIOD_32X      = WDTO_32S     // 8000ms = 8s
  WDT_PERIOD_64X      = WDTO_64S     // 8000ms = 8s
  ...
  WDT_PERIOD_16X    = 11,   // 8192 cycles = 8s
  WDT_PERIOD_32X    = 12,  // 8192 cycles = 8s
  WDT_PERIOD_64X    = 13   // 8192 cycles = 8s
